...
export const labs: LabMeta[] = [
  {
    ...
    summary:
      "사진 N장을 순차로 올릴 때와 Promise.all로 병렬로 올릴 때의 시간을, 핸드셰이크(고정 비용)와 전송(대역폭 공유)으로 쪼개서 비교하는 데모. 병렬이 왜 장수만큼 빨라지지 않는지 슬라이더로 직접 확인할 수 있습니다.",
  ...
  },
  {
    ...
    summary:
      "UI · Schema · DB 세 레이어가 같은 데이터를 각자의 룰로 다루면 어떤 일이 벌어지는지 '기타' 칩 하나로 재현하는 데모",
