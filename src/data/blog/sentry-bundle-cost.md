...
tags:
  ...
  - frontend
  - measurement
description: "프로덕션 에러 모니터링이 없던 시스템에 Sentry를 붙였다. 어떻게 붙였는지, 왜 그렇게 붙였는지, 그리고 500KB도 안 되던 번들이 모니터링만으로 +97KB(약 21%) 불어난 청구서 — 그 97KB가 어디로 갔는지 뜯어보고, Replay를 lazy-load로 분리해 초기 로드에서 40KB를 다시 들어낸 결과까지."
---
